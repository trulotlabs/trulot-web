...
function buildFieldMappingReport(): SourceRegistryRow[] {
  return [
    ...
    { fieldName: "permits.thisParcel", sourceTableView: "parcel_permit_terminal_v2 linked through parsed APN helper (planned DB view: trulot_permit_parcel_link_v1)", availableNow: "yes", nullBehavior: "Show no permits state.", sourceLabel: "City permit record via exact or parsed APN match", confidenceTier: "recorded" },
